...
import emblemElite from '../../assets/images/emblem/emblem-elite.jpeg';
import emblemLegendary from '../../assets/images/emblem/emblem-legendary.jpeg';
import emblemMythic from '../../assets/images/emblem/emblem-mythic.jpeg';
import emblemMythicLightbearer from '../../assets/images/emblem/emblem-mythic-lightbearer.png';
import emblemMythicMauler from '../../assets/images/emblem/emblem-mythic-mauler.png';
import emblemMythicWilder from '../../assets/images/emblem/emblem-mythic-wilder.png';
import emblemMythicGraveborn from '../../assets/images/emblem/emblem-mythic-graveborn.png';
import emblemMythicCelestial from '../../assets/images/emblem/emblem-mythic-celestial.png';
import emblemMythicHypogean from '../../assets/images/emblem/emblem-mythic-hypogean.png';
// import emblemMythicDimensional from '../../assets/images/emblem/emblem-mythic-dimensional.png';
...
export default {
    ...
    getEmblem(type) {
        if (type === 'ELITE') return emblemElite;
        if (type === 'LEGENDARY') return emblemLegendary;
        if (type === 'MYTHIC') return emblemMythic;
        if (type === 'MYTHIC_LIGHTBEARER') return emblemMythicLightbearer;
        if (type === 'MYTHIC_MAULER') return emblemMythicMauler;
        if (type === 'MYTHIC_WILDER') return emblemMythicWilder;
        if (type === 'MYTHIC_GRAVEBORN') return emblemMythicGraveborn;
        if (type === 'MYTHIC_CELESTIAL') return emblemMythicCelestial;
        if (type === 'MYTHIC_HYPOGEAN') return emblemMythicHypogean;
        // if (type === 'MYTHIC_DIMENSIONAL') return emblemMythicDimensional;
        return '';
    },
